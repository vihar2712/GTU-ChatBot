...
client.on("message", async (message) => {
  ...
  if (result && flag) {
    var user_inp = message.body.toString();
    // flag = true;
    ...
    // message.reply("Please enter proper enrollment number!");
    var user_inp = message.body.toUpperCase();
  }

  if (user_inp.startsWith("HI") || user_inp.startsWith("HELLO")) {
    ...
    switch (user_inp) {
      ...
      case "3":
        ...
        await message.reply("Press # to return to the main menu.");
        break;
